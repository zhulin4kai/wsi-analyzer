...
AI_MIN_TISSUE_RATIO = 0.005
AI_MASK_USE_HSV_SATURATION = True
AI_MASK_BLUR_KERNEL = 5
AI_DEVICE_POLICY = "auto"  # auto|cuda|mps|cpu
AI_CPU_BATCH_SIZE_DEFAULT = 2
AI_CPU_IO_WORKERS = 4
AI_CPU_STRIDE_SCALE = 1.5
AI_COARSE_TO_FINE_ENABLED = True
AI_COARSE_STRIDE_MULTIPLIER = 2
AI_COARSE_KEEP_RATIO = 0.35
AI_MAX_PATCHES_CPU = 20000
AI_MAX_PATCHES_ROI = 8000
